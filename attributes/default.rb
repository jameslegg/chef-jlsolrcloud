...
default['jlsolrcloud']['install']['url'] = 'http://archive.apache.org/dist/'
default['jlsolrcloud']['install']['url'] += 'lucene/solr/'
...
# JmxTrans configuration options.
default['jlsolrcloud']['jmxtrans']['interval'] = 60
